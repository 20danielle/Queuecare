...
/* modal pause */
.emb-modal-bg      { display:none; position:fixed; inset:0; background:rgba(0,0,0,.4); z-index:9999; align-items:center; justify-content:center; padding:16px; box-sizing:border-box; }
...
@media(max-width:480px){ .emb-modal{ padding:20px 18px; } }
</style>
