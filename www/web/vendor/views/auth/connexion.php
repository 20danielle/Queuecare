...
<head>
    ...
    <style>
        ...
        .link-forgot { font-size: .85rem; color: #0d6efd; text-decoration: none; font-weight: 500; }
...
<div class="auth-card">
    <div class="auth-logo">
        <img src="public/img/logo-queuecare.png" alt="QueueCare">
    ...
    <form method="POST" action="index.php?action=login" novalidate>
        ...
        <div class="mb-4">
            ...
            <div class="text-end mt-2">
                <a href="index.php?action=mot_de_passe_oublie" class="link-forgot">Mot de passe oublié ?</a>
            </div>
        </div>
