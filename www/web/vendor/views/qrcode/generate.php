    ...
    <style>
        * {
        ...
        @media (max-width: 480px) {
            body { padding: 12px; }
            .qr-header { padding: 22px 20px; }
            .qr-header h1 { font-size: 1.3rem; }
            .qr-body { padding: 20px; }
            .qr-display { padding: 18px; min-height: 260px; }
            ...
            printWindow.document.write(`
                ...
                <body>
                    <div class="print-container">
                        <img class="logo-print" src="${location.origin}/public/img/logo-queuecare-icon.png" alt="">
