...
<head>
  ...
  <style>
    ...
    .svc-logo-icon { width:46px; height:46px; background:rgba(255,255,255,.18); border:1.5px solid rgba(255,255,255,.3); border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.15rem; color:#fff; overflow:hidden; flex-shrink:0; }
    .svc-logo-icon img { width:100%; height:100%; object-fit:contain; padding:5px; }
    ...
    /* ── Responsive (svc-brand ne réutilise pas auth-brand) ── */
    @media (max-width:900px) {
      .svc-brand { width:100%; min-width:unset; }
      .svc-brand-inner { padding:32px 28px; flex-direction:row; flex-wrap:wrap; align-items:center; gap:20px; }
      .svc-logo { margin-bottom:0; }
      .svc-brand-title { font-size:1.75rem; }
      .svc-features, .svc-deco { display:none; }
    }
    @media (max-width:480px) {
      .svc-brand-inner { padding:28px 20px; }
      .svc-logo-icon { width:38px; height:38px; }
      .svc-logo-name { font-size:1.3rem; }
    }
  </style>
</head>
  ...
  <aside class="svc-brand">
    <div class="svc-brand-inner">
      <div class="svc-logo anim-fade-up">
        <span class="svc-logo-icon"><img src="public/img/logo-queuecare-icon.png" alt="QueueCare"></span>
