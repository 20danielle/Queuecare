...
<head>
  ...
  <style>
    ...
    .page-logo-icon { width:38px; height:38px; border-radius:10px; background:#fff; display:flex; align-items:center; justify-content:center; font-size:1rem; color:#fff; overflow:hidden; flex-shrink:0; }
    .page-logo-icon img { width:100%; height:100%; object-fit:contain; padding:4px; }
...
<header class="page-header">
  <div class="page-header-left">
    <div class="page-logo">
      <div class="page-logo-icon"><img src="public/img/logo-queuecare-icon.png" alt="QueueCare"></div>
      QueueCare
    </div>
    <div>
