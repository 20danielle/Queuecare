...
// ── Actions Web ──────────────────────────────────────────────────────────────
$webActions = [
    'login', 'logout', 'register_admin',
    'mot_de_passe_oublie', 'verifier_code', 'renvoyer_code', 'finaliser_reset_password',
];
...
if (!empty($action) && in_array($action, $webActions)) {
    ...
    switch ($action) {
        ...
        case 'finaliser_reset_password':
            $auth->finaliserResetPassword();
            break;
    }
    exit;
}
