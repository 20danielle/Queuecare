...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 24 juin 2026 à 07:15
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Consultations des patients (remplace rendez_vous)';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Planning journalier des sous-services par médecin';
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Historique des durées réelles — base du recalcul nocturne';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='QR codes générés pour les sous-services';
...
(10, 3, '531ddf80a10db66bc28d3be88c3899dfaf044fb47efe2b299f18334eb610bbdf', 'public/qrcodes/qrcode_3_1782283860.png', '2026-06-24 08:11:00', 'http://localhost/fil-attente3/scan_ticket.php?token=531ddf80a10db66bc28d3be88c3899dfaf044fb47efe2b299f18334eb610bbdf', 0, 'actif', '2026-06-24 07:51:01', 1);
...
(2, 'mathildemoumi@gmail.com', 'MOUMI MATHILDE', '$2y$10$.2Mi3klTmw5xVzFvxU4H8.3a/r9OZeb4VmsKAY0qkhwXHCxiwHesG', 'medecin', 1, NULL, 'actif', '2026-06-24 08:10:27', '2026-06-04 10:56:31', NULL),
(3, 'angezutchi@gmail.com', 'ange zutchi', '$2y$10$gm7ASaNRH2VuHd9MPXsN..6IrXz6j8slmMZ2dwUPr6AWK0W1vK2Au', 'gestionnaire', NULL, 1, 'actif', '2026-06-24 08:09:46', '2026-06-04 11:25:18', NULL),
(4, 'neillmoumi@gmail.com', 'NEILL MOUMI', '$2y$10$w9q6PnVR08/ZBRIttd60FuW4n.oidPlzLbmivb3FgIKEyJIxLkL6W', 'medecin', 3, NULL, 'actif', '2026-06-24 08:09:24', '2026-06-24 06:16:01', NULL);
