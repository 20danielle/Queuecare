...
<head>
    ...
    <style>
        ...
        .setup-logo { display: block; margin: 0 auto 10px; height: 56px; }
        @media (max-width: 480px) {
            body { padding: 16px 0; }
            .auth-card { padding: 1.75rem 1.4rem; }
            .setup-logo { height: 46px; }
        }
    </style>
</head>
<body>
<div class="auth-card">
    <div class="text-center mb-3">
        <img src="public/img/logo-queuecare-icon.png" alt="QueueCare" class="setup-logo">
